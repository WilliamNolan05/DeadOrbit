...
local menu        = "./.config/rofi/type-4/launcher.sh"
local notifications = "./config/swaync"
---------------------
---- KEYBINDINGS ----
---------------------
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("/home/william/.config/waybar/scripts/launch.sh"))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + R", hl.dsp.layout("togglesplit"))    -- dwindle only
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("hyprshot -m region"))
